...
| runnerGateway | object | `{"enabled":true,"image":{"pullPolicy":"IfNotPresent","repository":"ghcr.io/stellwerk-labs/platform-orchestrator-runner","tag":"v3.0.0"},"replicaCount":2,"resources":{"limits":{"cpu":"500m","memory":"256Mi"},"requests":{"cpu":"50m","memory":"64Mi"}},"service":{"port":8080}}` | --------------------------------------------------------------------------- The gateway is the only runner-facing component. It translates the public HTTPS protocol into the internal JetStream streams and object stores. |
