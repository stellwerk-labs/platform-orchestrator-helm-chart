...
| iam.image | object | `{"repository":"ghcr.io/stellwerk-labs/platform-orchestrator-iam","tag":"v2.3.0"}` | Container image for IAM |
...
| iam.image.tag | string | `"v2.3.0"` | Image tag |
