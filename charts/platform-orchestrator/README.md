...
Chart `0.7.0-rc.1` adds Module Version Management, including immutable versions,
...
and NATS JetStream architecture. See the [release notes](../../docs/releases/v0.7.0-rc.1.md)
...
| console.image | object | `{"repository":"ghcr.io/stellwerk-labs/platform-orchestrator-frontend","tag":"v1.3.0-rc.2@sha256:195e43a2d420c97baa8f7bac2a1c9e4c5bf10fc4fd518fc8c6e4d48c28513198"}` | Container image for the console |
...
| console.image.tag | string | `"v1.3.0-rc.2@sha256:195e43a2d420c97baa8f7bac2a1c9e4c5bf10fc4fd518fc8c6e4d48c28513198"` | Image tag |
...
| control-plane.image | object | `{"repository":"ghcr.io/stellwerk-labs/platform-orchestrator-cp","tag":"v3.0.0-rc.4@sha256:fbe504237c77a22a2d7aea7cf954b78316717551f2f033b2093f3184cb900faf"}` | Container image for the control plane |
...
| control-plane.image.tag | string | `"v3.0.0-rc.4@sha256:fbe504237c77a22a2d7aea7cf954b78316717551f2f033b2093f3184cb900faf"` | Image tag |
...
| data-plane.image | object | `{"repository":"ghcr.io/stellwerk-labs/platform-orchestrator-dp","tag":"v3.2.0-rc.4@sha256:55cb9f90c9c4af344fdb3417c55676fd17cdc59c653fb324a53ec4808b883c4b"}` | Container image for the data plane |
...
| data-plane.image.tag | string | `"v3.2.0-rc.4@sha256:55cb9f90c9c4af344fdb3417c55676fd17cdc59c653fb324a53ec4808b883c4b"` | Image tag |
...
| iam.image | object | `{"repository":"ghcr.io/stellwerk-labs/platform-orchestrator-iam","tag":"v2.4.0-rc.1@sha256:d8e3e499e2d33f2cbd351f7bdf3c2409c35b5a2d39a859dcefab4a3e421d4252"}` | Container image for IAM |
...
| iam.image.tag | string | `"v2.4.0-rc.1@sha256:d8e3e499e2d33f2cbd351f7bdf3c2409c35b5a2d39a859dcefab4a3e421d4252"` | Image tag |
...
| runnerGateway | object | `{"enabled":true,"image":{"pullPolicy":"IfNotPresent","repository":"ghcr.io/stellwerk-labs/platform-orchestrator-runner","tag":"v3.1.0-rc.2@sha256:abd5ab267e87b889e15236f8615c84e4b70d319e2f70253176963e652a178419"},"replicaCount":2,"resources":{"limits":{"cpu":"500m","memory":"256Mi"},"requests":{"cpu":"50m","memory":"64Mi"}},"service":{"port":8080}}` | --------------------------------------------------------------------------- The gateway is the only runner-facing component. It translates the public HTTPS protocol into the internal JetStream streams and object stores. |
