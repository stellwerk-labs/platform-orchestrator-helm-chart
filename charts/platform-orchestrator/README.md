...
| control-plane.image | object | `{"repository":"ghcr.io/stellwerk-labs/platform-orchestrator-cp","tag":"v2.0.0"}` | Container image for the control plane |
...
| control-plane.image.tag | string | `"v2.0.0"` | Image tag |
