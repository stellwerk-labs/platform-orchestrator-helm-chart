...
grep -Fq 'image: "ghcr.io/stellwerk-labs/platform-orchestrator-iam:v2.4.0-rc.1@sha256:d8e3e499e2d33f2cbd351f7bdf3c2409c35b5a2d39a859dcefab4a3e421d4252"' "$rendered"
